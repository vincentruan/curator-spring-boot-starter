...
@SpringBootTest
public class CrudExampleTest extends AbstractCuratorMockServer {
    ...
    @Test
    public void testCrudExample() throws Exception {
        create(client, "/example", new byte[0]);
        create(client, PATH, "哈哈哈哈O(∩_∩)O哈哈~".getBytes());
